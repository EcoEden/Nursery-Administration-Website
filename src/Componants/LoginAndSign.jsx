    ...
    <div className='w-full  mb-10 pt-24 '>
      <div className='w-[80vh] h-screen mx-auto my-10 px-10 py-15 bg-gray-100'>
        ...
        <h1 className='mt-10  text-2xl font-bold'>Sign Up</h1>
            <input type="text" placeholder='Enter your name' className='h-[50px]  border-orange-700	border-solid	w-full pl-5 border-2 rounded-md outline-none text-lg	' />
            ...
            <div className='flex items-center mt-6 gap-4 text-lg font-medium text-slate-500 text-sm	'>
