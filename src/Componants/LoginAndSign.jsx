    ...
    <div className='w-full  mb-10 pt-24 '>
      ...
      <div className='w-[80vh] h-screen mx-auto my-10 px-10 py-15 bg-gray-100'>
        <div className='flex flex-col gap-10 '>
          ...
          <input type="text" placeholder='Enter your name' className='h-[50px]  border-orange-700	border-solid	w-full pl-5 border-2 rounded-md outline-none text-lg	gap-4' />
