...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#F5F5F5] text-gray-700 py-10 mt-3 border-t select-none cursor-default bottom-0">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {userRole === 'admin' || userRole === 'seller' ? (
                <li><Link to={userRole === 'admin' ? '/admin-dashboard' : '/seller-dashboard'} className="hover:text-secondary">Dashboard</Link></li>
              ) : (
                <>
